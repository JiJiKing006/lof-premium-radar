...
DEPLOY_WX_APP_ID="${DEPLOY_WX_APP_ID:-wxd827a0e78b5ce07a}"
DEPLOY_WX_APP_SECRET="${DEPLOY_WX_APP_SECRET:-}"
DEPLOY_WX_SUBSCRIBE_TEMPLATE_ID="${DEPLOY_WX_SUBSCRIBE_TEMPLATE_ID:-nChCRD1ljtNdWE20NSZIogo5tYX5sX4xP4UPEdZVLyM}"
...
ssh "${SSH_OPTS[@]}" "$REMOTE" \
  "DEPLOY_PATH='$DEPLOY_PATH' \
   ...
   DEPLOY_WX_APP_ID='$DEPLOY_WX_APP_ID' \
   DEPLOY_WX_APP_SECRET='$DEPLOY_WX_APP_SECRET' \
   DEPLOY_WX_SUBSCRIBE_TEMPLATE_ID='$DEPLOY_WX_SUBSCRIBE_TEMPLATE_ID' \
...
Environment=WX_APP_ID=${DEPLOY_WX_APP_ID}
Environment=WX_APP_SECRET=${DEPLOY_WX_APP_SECRET}
Environment=WX_SUBSCRIBE_TEMPLATE_ID=${DEPLOY_WX_SUBSCRIBE_TEMPLATE_ID}
Environment=WX_SUBSCRIPTION_FILE=${DEPLOY_PATH}/shared/wechat-subscriptions.json
