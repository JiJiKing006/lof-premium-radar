...
export function getDataSourceHealth() {
  const names = ['palmmicro', 'haoetf', 'eastmoney', 'eastmoney-index', 'eastmoney-trend', 'eastmoney-history-nav', 'eastmoney-history-price', 'sina-history-price', 'tiantian-subscription', 'sse-share', 'szse-share', 'sina', 'akshare', 'tiantian', 'jisilu', 'lof', 'cache'];
